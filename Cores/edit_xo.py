...
heading = Label(xo_edit_window , text = "Flappy Birds Edit Sittings" , font = 'Verdana 15 bold')
...
p2s_lbl = Label(xo_edit_window, text = "Player1 Symbol:  " , font = 'Verdana 10 bold')
